    ...
    std::optional<c10::ScalarType> const& out_dtype)
{
    ...
    {
    case 4:
        tk::invokeRouterGemm<__nv_bfloat16, 4, kNumExperts, kHiddenDim>(
        ...
        break;
    case 5:
        tk::invokeRouterGemm<__nv_bfloat16, 5, kNumExperts, kHiddenDim>(
            reinterpret_cast<float*>(out.mutable_data_ptr()), reinterpret_cast<__nv_bfloat16 const*>(mat_a.data_ptr()),
            reinterpret_cast<__nv_bfloat16 const*>(mat_b.data_ptr()), stream);
        break;
    case 6:
        tk::invokeRouterGemm<__nv_bfloat16, 6, kNumExperts, kHiddenDim>(
            reinterpret_cast<float*>(out.mutable_data_ptr()), reinterpret_cast<__nv_bfloat16 const*>(mat_a.data_ptr()),
            reinterpret_cast<__nv_bfloat16 const*>(mat_b.data_ptr()), stream);
        break;
    case 7:
        tk::invokeRouterGemm<__nv_bfloat16, 7, kNumExperts, kHiddenDim>(
            reinterpret_cast<float*>(out.mutable_data_ptr()), reinterpret_cast<__nv_bfloat16 const*>(mat_a.data_ptr()),
            reinterpret_cast<__nv_bfloat16 const*>(mat_b.data_ptr()), stream);
        break;
    case 8:
        tk::invokeRouterGemm<__nv_bfloat16, 8, kNumExperts, kHiddenDim>(
            reinterpret_cast<float*>(out.mutable_data_ptr()), reinterpret_cast<__nv_bfloat16 const*>(mat_a.data_ptr()),
            reinterpret_cast<__nv_bfloat16 const*>(mat_b.data_ptr()), stream);
        break;
    default: throw std::invalid_argument("Invalid num_tokens, only supports 4, 5, 6, 7, 8"); break;
    }
    return out;
}
